...
//int read_adc(){int a;a=rand();a=a/200;a=a+2048;return a;}
...
{   0,1000},{   0,1000},{   0, 100},{   0,  30},{   1,   5},{   1,  10},{-999,9999},{-999,9999},{   0,   1},
{   0,1000},{   0,1000},{   0, 100},{   0,  30},{   1,   5},{   0,   1}};
const flash float FAKTORY[30]={0,
10.00,15.00,8,8,0,1,
0,1,1,1,1,1,0.00,20.00,2,2,10,10,2,5,0,50,0,0,0,0,0,0};
